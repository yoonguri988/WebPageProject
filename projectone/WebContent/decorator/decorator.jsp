...
<body style="background-color: rgb(231,228,211); overflow-x:scroll;" >

<!-- Navbar (sit on top) -->
<div class="w3-top">
  <div class="w3-bar" style="background-color: rgb(231,228,211);" id="myNavbar">
    <a href="${path }/model2/member/main.do" style="font-style: italic;" class="w3-bar-item  w3-button w3-hover-pale-red w3-hover-text-yellow w3-hover-text-grey">HOME</a>
...
<!-- #out {
 ...
 <div style="display: table;" class="bgimg-1" id="out"> 
