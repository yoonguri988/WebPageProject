...
<form action="update.do" method="post" name="f">
<input type="hidden" name="qanum" value="${qa.qanum }">
<table border ="1" >
	<tr><td><h1 style="font-size: 68px;">글 수정</h1></td></tr>
	<tr>
		<th style="font-size: 48px;">질문</th>
		<td><textarea style="width: 100%; font-size: 32px;" rows="3" name="question" >${qa.question}</textarea></td>
	</tr>
	<tr>
		<th style="font-size: 48px;">정답</th>
		<td><input style="width: 100%; font-size: 32px;" type="text" class="inputdb"  name="answer" id="content1" value="${qa.answer}"></td>
	</tr>
	<tr>
		<td colspan="2">
		<input id="find" type="submit" value="수정">
		</td>
	</tr>
</table>
</form>
